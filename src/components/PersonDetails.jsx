...
import { fetchActorDetails } from "../store/actions/person-actions";
      ...
      <div className="w-full flex">
        <div className="w-[20%]">
          <img
            ...
            src={`https://image.tmdb.org/t/p/original/${info.detail.profile_path || info.detail.poster_path}`}
            alt=""
          />
        ...
        <div className="w-[80%] ml-[5%]">
          ...
          <div className="w-full h-[50vh] overflow-x-hidden overflow-y-auto shadow-xl mt-5 shadow-[rgba(255,255,255,.3)] border-2 border-zinc-700 p-5 text-zinc-400 list-disc">
            {info[category + "Credits"].cast.map((c, i) => (
              <li
                key={i}
                className="hover:text-white hover:bg-[#19191d] duration-300 cursor-pointer p-5"
              >
